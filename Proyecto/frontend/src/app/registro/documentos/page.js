                ...
                <div className="space-y-6">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      {preview.carnet_frontal && <img src={preview.carnet_frontal} alt="carnet_frontal" className="max-h-32 rounded object-contain" />}
                    </div>
                  </div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      {preview.carnet_trasera && <img src={preview.carnet_trasera} alt="carnet_reverso" className="max-h-32 rounded object-contain" />}
                    </div>
                  </div>
